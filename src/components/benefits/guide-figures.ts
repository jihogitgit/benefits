...
export const GUIDE_FIGURES: Record<string, { width: number; height: number }> = {
  ...
  'jeonip-apply-window.svg': { width: 480, height: 220 },
  'jeonip-installments.svg': { width: 480, height: 260 },
  'kosaf-grade-threshold.svg': { width: 480, height: 276 },
  'kosaf-income-brackets.svg': { width: 480, height: 192 },
  'nanim-daegu-topup.svg': { width: 480, height: 210 },
  'nanim-local-layers.svg': { width: 480, height: 250 },
  'pyeeop-demolition-cap.svg': { width: 480, height: 280 },
  'pyeeop-retry-fund-tiers.svg': { width: 480, height: 200 },
